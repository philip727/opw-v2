...
pub const CHUNK_RERENDER_DISTANCE_THRESHOLD: f32 = 64.0;
...
pub const PRECIPITATION_SCALE: f64 = 5.0;

pub const WATER_HEIGHT_THRESHOLD: f64 = 0.35;
pub const WATER_PRECIPITATION_THRESHOLD: f64 = 0.27;
